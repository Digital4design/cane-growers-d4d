    ...
    <section class="membership-scroll py-44 bg-off-white-100 relative overflow-hidden">
        <div class="custom-container max-w-2xl mx-auto text-center">
            ...
            <svg class="scroll-bar absolute left-0 right-0 mx-auto" xmlns="http://www.w3.org/2000/svg" width="2" height="188" viewBox="0 0 2 188" fill="none">
                <path d="M1 0L1.00001 188" stroke="#1E1E1E"/>
            </svg>
        </div>
    </section>
