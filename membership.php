    ...
    <?php @include './components/internal-banner.php'; ?>
      ...
      <!-- Key issues -->
      <section class="bg-off-white-100 py-24">
        ...
        <div class="membership-card my-24">
    ...
    <section class="membership-scroll">
        <div class="container max-w-2xl mx-auto text-center">
            <h3>Six ways your membership with CANEGROWERS will help you and your business</h3>
            <svg class="scroll-down-membership mx-auto mt-12 cursor-pointer group" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                ...
                <path class="group-hover:stroke-dark-green" d="M22 17.0001L18 21.0001L14 17" stroke="#1E1E1E" stroke-width="2"/>
            </svg>
        </div>
    </section>
        ...
        <div class="relative h-screen flex flex-wrap items-end bg-membership-overlay">
            <div class="container mx-auto z-40 py-16">
                <div class="max-w-xl top-0 left-0">
                    ...
                    <h5 class="text-white pb-4">Strong advocacy and representation</h5>
        ...
        <div class="relative h-screen flex flex-wrap items-end bg-membership-overlay">
            <div class="container mx-auto z-40 py-16">
                <div class="max-w-xl top-0 left-0">
                    ...
                    <h5 class="text-white pb-4">Access to influential organisations and decision makers</h5>
        ...
        <div class="relative h-screen flex flex-wrap items-end bg-membership-overlay">
            <div class="container mx-auto z-40 py-16">
                <div class="max-w-xl top-0 left-0">
                    ...
                    <h5 class="text-white pb-4">Representation from the farm up</h5>
        ...
        <div class="relative h-screen flex flex-wrap items-end bg-membership-overlay">
            <div class="container mx-auto z-40 py-16">
                <div class="max-w-xl top-0 left-0">
                    ...
                    <h5 class="text-white pb-4">Member services tailored to your business</h5>
        ...
        <div class="relative h-screen flex flex-wrap items-end bg-membership-overlay">
            <div class="container mx-auto z-40 py-16">
                <div class="max-w-xl top-0 left-0">
                    ...
                    <h5 class="text-white pb-4">Access to industry programs and incentives funding</h5>
                    <p>CANEGROWERS is the “go to” voice on cane growing issues. When Government needs to hear from a reliable source, or provide critical needs to respond to natural disasters, it is through CANEGROWERS that these functions are delivered.</p>
                </div>
            </div>
        ...
        <div class="relative h-screen flex flex-wrap items-end bg-membership-overlay">
            <div class="container mx-auto z-40 py-16">
                <div class="max-w-xl top-0 left-0">
                    ...
                    <h5 class="text-white pb-4">Regular communications and grower events</h5>
